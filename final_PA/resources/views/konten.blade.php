        ...
        <div class="row">
            <div class="col-lg-3 mb-5">
                ...
                <ul class="list-group">
                    ...
                    <a class="no-decoration" href="{{ route('all.konten.wisatwan', ['kategori_id' => $item->id]) }}">
            ...
            <div class="col-lg-9">
                <hr>
                <h2 class="text-center"><strong>Daftar Hewan</strong></h2>
                <hr>
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="card h-8">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text text-truncate">{!! \Illuminate\Support\Str::limit($item->detail, 30, '...') !!}</p>
